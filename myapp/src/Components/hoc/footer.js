    ...
    return (
        <div className="row footer" style={{background:"black",opacity:"0.7"}}>
            ...
            <div className="col-lg-6 email">
                ...
                <div className=" col-lg-5 title"><p className="des"><FontAwesomeIcon icon={faEnvelope} className="icon"/>Email:-</p></div>
            ...
            <div className="col-lg-6 email">
                ...
                <div className=" col-lg-2 title"></div>
                <div className=" col-lg-5 title"><p className="des"><FontAwesomeIcon icon={faInstagram} className="icon"/>Email:-</p></div>
                <div className="col-lg-5 info"><p className="des">xxxxx@gmail.com</p></div>
                </div>
            </div>
            <div className="col-lg-6 contact">
                <div className="row">
                <div className=" col-lg-2 title"></div>
                <div className=" col-lg-5 title"><p  className="des"> <FontAwesomeIcon
                                    icon={faFacebook}
                                    className="icon"
                                />
                                Contact:-</p></div>
